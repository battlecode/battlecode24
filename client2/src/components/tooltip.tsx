...
const Tooltip: React.FC<TooltipProps> = ({
  ...
  return (
    <div className={`group relative h-max w-max flex`}>
      {children}
      <div
        className={`pointer-events-none select-none absolute z-20 mb-1 w-max max-w-[200px] rounded bg-gray-800 px-2 py-1
