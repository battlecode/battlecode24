...
public final class GameMap extends Table {
   ...
   */
  public HeadquarterTable headquarters() { return headquarters(new HeadquarterTable()); }
  public HeadquarterTable headquarters(HeadquarterTable obj) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  /**
   * The random seed of the map.
   */
  public int randomSeed() { int o = __offset(16); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * The walls on the map.
   */
  public boolean walls(int j) { int o = __offset(18); return o != 0 ? 0!=bb.get(__vector(o) + j * 1) : false; }
  public int wallsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer wallsAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer wallsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  /**
   * The clouds on the map.
   */
  public boolean clouds(int j) { int o = __offset(20); return o != 0 ? 0!=bb.get(__vector(o) + j * 1) : false; }
  public int cloudsLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer cloudsAsByteBuffer() { return __vector_as_bytebuffer(20, 1); }
  public ByteBuffer cloudsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 20, 1); }
  /**
   * The currents on the map.
   */
  public int currents(int j) { int o = __offset(22); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int currentsLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer currentsAsByteBuffer() { return __vector_as_bytebuffer(22, 4); }
  public ByteBuffer currentsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 4); }
  /**
   * The island each square on the map belongs to.
   */
  public int islands(int j) { int o = __offset(24); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int islandsLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer islandsAsByteBuffer() { return __vector_as_bytebuffer(24, 4); }
  public ByteBuffer islandsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 24, 4); }
  /**
   * The resource type each square is.
   */
  public int resources(int j) { int o = __offset(26); return o != 0 ? bb.getInt(__vector(o) + j * 4) : 0; }
  public int resourcesLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  public ByteBuffer resourcesAsByteBuffer() { return __vector_as_bytebuffer(26, 4); }
  public ByteBuffer resourcesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 26, 4); }

  public static void startGameMap(FlatBufferBuilder builder) { builder.startObject(12); }
  ...
  public static void addHeadquarters(FlatBufferBuilder builder, int headquartersOffset) { builder.addOffset(5, headquartersOffset, 0); }
  public static void addRandomSeed(FlatBufferBuilder builder, int randomSeed) { builder.addInt(6, randomSeed, 0); }
  public static void addWalls(FlatBufferBuilder builder, int wallsOffset) { builder.addOffset(7, wallsOffset, 0); }
  ...
  public static void addClouds(FlatBufferBuilder builder, int cloudsOffset) { builder.addOffset(8, cloudsOffset, 0); }
  ...
  public static void addCurrents(FlatBufferBuilder builder, int currentsOffset) { builder.addOffset(9, currentsOffset, 0); }
  ...
  public static void addIslands(FlatBufferBuilder builder, int islandsOffset) { builder.addOffset(10, islandsOffset, 0); }
  ...
  public static void addResources(FlatBufferBuilder builder, int resourcesOffset) { builder.addOffset(11, resourcesOffset, 0); }
