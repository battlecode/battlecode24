...
public final class GameMap extends Table {
  ...
  public BooleanVector cloudsVector() { return cloudsVector(new BooleanVector()); }
  public BooleanVector cloudsVector(BooleanVector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  ...
  public IntVector currentsVector() { return currentsVector(new IntVector()); }
  public IntVector currentsVector(IntVector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  ...
  public IntVector islandsVector() { return islandsVector(new IntVector()); }
  public IntVector islandsVector(IntVector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
  ...
  public IntVector resourcesVector() { return resourcesVector(new IntVector()); }
  public IntVector resourcesVector(IntVector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), bb) : null; }
